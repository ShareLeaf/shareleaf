      ...
      <Grid spacing={{ xs: 6, md: 10 }} justifyContent="center" alignItems="center" container>
        <Grid item md={10} lg={8} mx="auto">
          ...
          <TypographyH1 sx={{ mb: 2 }} variant="h1">
            ResumeRepo CV Versioning and Tracking
          </TypographyH1>
          <TypographyH2
          ...
          <Grid container spacing={3} mt={5}>
            <Grid item md={6}>
              ...
              <Typography variant="h4">
                <Box sx={{ pb: 2 }}><b>Powered by Material-UI</b></Box><Typography component="span" variant="subtitle2"> - A simple platform for helping you organize your CV</Typography>
              </Typography>
            </Grid>
            <Grid item md={6}>
              <TsAvatar>
              ...
              <Typography variant="h4">
                <Box sx={{ pb: 2 }}><b>Built with Typescript</b></Box><Typography component="span" variant="subtitle2"> - ResumeRepo provides features to edit and keep track of your job resumes and cover letters.</Typography>
              </Typography>
            </Grid>
          </Grid>
        </Grid>
