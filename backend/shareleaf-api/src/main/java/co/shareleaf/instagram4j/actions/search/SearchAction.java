package co.shareleaf.instagram4j.actions.search;

import java.util.concurrent.CompletableFuture;
import co.shareleaf.instagram4j.IGClient;
import co.shareleaf.instagram4j.requests.fbsearch.FbsearchPlacesRequest;
import co.shareleaf.instagram4j.requests.tags.TagsSearchRequest;
import co.shareleaf.instagram4j.requests.users.UsersSearchRequest;
import co.shareleaf.instagram4j.responses.fbsearch.FbsearchPlacesResponse;
import co.shareleaf.instagram4j.responses.tags.TagsSearchResponse;
